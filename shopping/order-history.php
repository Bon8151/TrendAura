...
?>
    ...
    <a href="javascript:void(0);" onClick="popUpWindow('track-order.php?oid=<?php echo htmlentities($row['orderid']);?>');" class="btn btn-sm btn-info mb-2" title="Track order">Track</a>
    <br>
    <a href="javascript:void(0);" onClick="popUpWindow('generate-bill.php?oid=<?php echo htmlentities($row['orderid']);?>');" class="btn btn-sm btn-success" title="Generate Bill">Generate Bill</a>
</td>
